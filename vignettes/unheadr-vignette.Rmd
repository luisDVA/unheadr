...
To apply this approach to all cells in a spreadsheet, we call `annotate_mf_all()`. In this other bundled example file, negative values (first quarer losses) are indicated by bold. 
