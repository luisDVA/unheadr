...
Sometimes embedded subheaders can't be matched by content or context, but they share the same formatting in a spreadsheet file. Encoding data as formatting is also a very common practice.
...
`annotate_mf_all()` applies the same approach to all values in the dataset. Similar to working 'across' _everything_ with dplyr.
